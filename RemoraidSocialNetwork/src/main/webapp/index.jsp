        ...
        <div class="sidebar-navigation hidde-sm hidden-xs">
            ...
            <div id="loginBloque">
                   <img id="foto" src=<%= application.getContextPath()+("/img/remoraid_logo.png") %>>
                    ...
                    <a class="acceder"  style="font-size: 24px; display:inline-block;" href=<%= application.getContextPath()+("/LoginController") %>>INICIAR SESIÓN</a> >
            
                    <a class="acceder"  style="font-size: 24px; display:inline-block;" href="<%= application.getContextPath()+("/RegistroController") %> ">REGISTRARSE</a> 
