...
-->
	...
	<link rel="stylesheet" href=<%= application.getContextPath()+ ("css/fontAwesome.css")%>>
	<link rel="stylesheet" href=<%= application.getContextPath()+ ("css/light-box.css")%>>
	<link rel="stylesheet" href=<%= application.getContextPath()+ ("css/owl-carousel.css")%>>
	<link rel="stylesheet" href=<%= application.getContextPath()+ ("css/templatemo-style.css")%>>
	<link rel="stylesheet" href=<%= application.getContextPath()+ ("css/barraBusqueda.css")%>>
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,800" rel="stylesheet">
    <link rel="shortcut icon" type="image/png" href=<%= application.getContextPath()+ ("img/remoraid_logo.png")%>/>
    <script src=<%= application.getContextPath()+ ("js/vendor/modernizr-2.8.3-respond-1.4.2.min.js")%>></script>
...
<body>
   ...
   <section id="blog" class="content-section">
        <div class="section-heading">
            <h1>Bienvenido a<br><em>REMORAID</em></h1>
            <p>Usted se encuentra en nuestra página principal aquí podrá buscar a otras rémoras
            <br> con las que colaborar, proyectos en los que colaborar y promociones de ambos.</p>
            ...
            <div class="tabs-content">
                <div class="wrapper">
                    <ul class="tabs clearfix" data-tabgroup="first-tab-group">
                        <li><a href="#proyectosColaborativos" class="active">Proyectos Colaborativos</a></li>
                        <li><a href="#ProyectosPromocionativos">Proyectos Promocionativos</a></li>
                        <li><a href="#colaboradores">Remoras Colaborativas</a></li>
                        <li><a href="#promocionDeRemoras">Remoras Promocionativas</a></li>
                    </ul>
                    <section id="first-tab-group" class="tabgroup">
                        <div id="proyectosColaborativos">
                            <ul>
                                <li>
                                    <div class="item">
                        ...
                        <div id="ProyectosPromocionativos">
                            <ul>
                                <li>
                                    <div class="item">
                                        <img src="img/blog_3.jpg" alt="">
